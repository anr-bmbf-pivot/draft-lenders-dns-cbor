...
| Standard RR with int rdata   | 12 bytes + name length + rdata length | 5 bytes (name and class elided, type < 24, rdata < 24) | 27 bytes + name length (type > 255, class > 255, name length > 255, rdata > 2147483648 or rdata < -4294967296) |
